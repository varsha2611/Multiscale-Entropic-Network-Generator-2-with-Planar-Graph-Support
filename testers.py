...
def replica_vs_original(seed=None, figpath=None, generator_func=None, G=None, params=None, num_replicas = 150, title_infix='', metrics=None, intermediates=False, n_jobs=-1, store_replicas=False):
...
def read_all_files():
    import os
    replicas = []
    files = os.listdir("/home/varsha/Documents/final_results/LFR/planar/Boeing/")
    for file in files:
        tmp = nx.read_gml("/home/varsha/Documents/final_results/LFR/planar/Boeing/"+file)
